...
|---|---|
| `smelt_tools_and_armor.js` | Every tool & armor piece, detected by scanning all crafting recipes at load (259 recipes on an ATM10 install). Vanilla netherite gear is listed by hand since it has no crafting recipe. |
...
sword 2, hoe 2, shovel 1 (in ingots).
